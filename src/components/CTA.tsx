          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="mt-6 text-muted-foreground max-w-lg">
                Tell us what you're shipping. We'll come back with a scoped plan,
                a timeline, and the team that will deliver it.
              </p>
              <a
                href="mailto:support@telematrixglobal.com"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                { icon: Mail, label: "Email", value: "support@telematrixglobal.com" },
